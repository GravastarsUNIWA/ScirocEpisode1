...
from head import move_head_up, move_head_left15, move_head_left346, move_head_left2
...
#=================================================================
    ...
    # -------------------------- 3 -----------------------------
        ...
        smach.StateMachine.add('STATUS3',
                               ...
                               transitions={'done':'VIEW5'})

    # -------------------------- 5 -----------------------------
        smach.StateMachine.add('VIEW5',
                               move_head_left15('rotate head'),
